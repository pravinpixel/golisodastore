  ...
  if (compareList) {
    return (
      <>
        <Helmet>
          <title>
            {products?.meta?.title || "Golisoda | Compare Products"}
          </title>
          ...
          <div className="container py-4">
            <div className="table-responsive">
              <table className="table tableLg">
                    ...
                    {compareList.products.map((product, index) => (
                      <td key={index} className="p-lg-5">
                        <div className="compare-card text-center position-relative">
                          ...
                          <div
                            className="bg-white h-100 p-3 cursor"
                            onClick={() =>
                ...
                <tbody>
                  {Object.entries(compareList.informations).map(
                    (info, index) => (
                      <tr key={index}>
                        <td className="fw-bold" width={250}>
                          {info[0]}
                        </td>
