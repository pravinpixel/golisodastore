              ...
              <ListGroup.Item key={index} action >
                <div className="row">
                  ...
                  <div className="col-md-4 text-center">
                    ...
                    <iframe className="rounded border shadow-sm bg-secondary" width={'100%'} src={item.map_link}
                      title={item.title} loading="lazy" referrerPolicy="no-referrer-when-downgrade" ></iframe>
                  </div>
                </div>
              </ListGroup.Item>
            ))}
