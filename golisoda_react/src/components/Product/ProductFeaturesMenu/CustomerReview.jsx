...
function CustomerReview({product, is_review}) {
  ...
  const handleRating = (comments) => {
    ...
    axios
      .post(`${process.env.REACT_APP_BASE_URL}/add/customer/reviews`, {
      ...
      <div className="row">
        ...
        <div className="col-lg-4">
          ...
          <div className="d-flex flex-wrap mt-4">
            <div className="badge bg-primary-light btn-sm mx-1 mb-2">
              Awesome
            </div>
            <div className="badge bg-primary-light btn-sm mx-1 mb-2">
              Good Quality
          ...
          {authUser.isLoggedIn ? (
                  ...
                  <Form onSubmit={handleSubmit(handleRating)}>
                    <div className="mb-4">
                      ...
                      <Rating
                        ...
                        fillIcon={
                          <img
                            src={require("../../../assets/icons/star-yellow.png")}
                            width={30}
                            alt="star"
                            className="me-2"
                          />
                        ...
                        emptyIcon={
                          <img
                            src={require("../../../assets/icons/star-gray.png")}
                            width={30}
                            alt="star"
                            className="me-2"
                          />
                    ...
                    <textarea
                      name="review"
                      {...register("review", {required: true, max: 255})}
                      placeholder="Enter Your Review Here"
                      className={`form-control ${
                        errors.review ? "border-primary" : ""
                      }`}
                      cols="30"
                      rows="10"
                    ></textarea>
            ...
            <div className="d-flex align-items-center fw-500">
              <button
                className="btn btn-link text-info px-1 fw-500"
                onClick={LoginAuth}
              >
                {" "}
                Sign In{" "}
