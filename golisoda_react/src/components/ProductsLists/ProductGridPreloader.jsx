...
function ProductGridPreloader() {
  return (
    <div className='row g-2 g-lg-0 border-start'>
      <div className='product-card overflow-hidden col-lg-3 border-bottom col-md-3 col-3'>
        <div className="row m-0" >
          ...
          <div className="ari-cnt text-start w-100 bg-white col-md-12">
...
export default ProductGridPreloader