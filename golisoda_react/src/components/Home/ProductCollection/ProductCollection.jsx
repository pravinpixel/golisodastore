...
function ProductCollection() {
  const productCollections = useSelector(
    (state) => state.homePageCollection.productCollections
  );
      ...
      <div className="section-wrapper section-border-bottom" key={index}>
        <div className="container px-0 px-md-3">
          <div className="d-flex justify-content-between align-items-center mb-2 mb-md-4 px-3">
            <h3 className="h2 section-title m-0 w-100 text-center">
              {collection.collection_name}
            </h3>
            <FilterLink
              to={`/products?collection=${collection.collection_slug}`}
            >
          ...
          <div
            className={
              collection.collection_name === "New Arrivals"
                ? "newarrival-slider arrival-slider"
                : "arrival-slider"
            }
          >
